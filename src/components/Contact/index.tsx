...
const Contact = () => {
  ...
  return (
    <div className="relative my-5 py-5 lg:my-10 max-w-auto lg:max-w-5xl px-4 mx-auto z-10 rounded-sm bg-white shadow-three dark:bg-gray-dark sm:py-16 lg:py-20 xl:py-28">
      <h3 className="mb-4 pt-5 md:pt-0 text-2xl font-bold leading-tight text-black dark:text-white">
        Need Help? Open a Ticket
      </h3>
      <p className="mb-11 border-b border-body-color border-opacity-25 pb-11 text-base leading-relaxed text-body-color dark:border-white dark:border-opacity-25">
        Our support team will get back to you ASAP.
      </p>
      <form action="https://getform.io/f/bwngonqa" method="POST">
